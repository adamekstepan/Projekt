...
if(isset($_POST['register'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $message[] = 'úspešně registrován, přihlaš te se!';
      }
   }
...
if(isset($_POST['add_to_cart'])){
   ...
   if($user_id == ''){
      $message[] = 'prosím nejdříve se přihlaš te!';
   }else{
...
<section class="order" id="order">
   ...
   <?php
      ...
      <div class="grand-total"> Celkem : <span>$<?= $grand_total; ?>/-</span></div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method" class="box">
               <option value="cash on delivery">dobírka</option>
               <option value="credit card">kreditní carta</option>
               <option value="paytm">platební karta</option>
